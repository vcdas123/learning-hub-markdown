...
export const MARKDOWN_RULES = [
  "The first line MUST be the note title as the only level-1 heading: '# My Title'. A note will not have more than 1 H1. This becomes the note's title unless you provide an explicit title when uploading.",
  ...
  "Fenced code blocks MUST declare a language after the backticks, e.g. ```sql, ```python, ```dockerfile, ```bash. If no specific language applies, use ```text. Code blocks must never be left without a type.",
